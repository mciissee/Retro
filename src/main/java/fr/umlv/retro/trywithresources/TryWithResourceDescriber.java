...
class TryWithResourceDescriber implements FeatureDescriber {
	...
	public TryWithResourceDescriber(ClassInfo ci, MethodInfo mi, int lineNumber, Type[] captures, String descriptor, Handle method) {
